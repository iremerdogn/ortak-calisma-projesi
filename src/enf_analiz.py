...
# --- Dosya listesi ---
files = ["src/ornek_kayit.wav", "src/ornek2.wav"]
...
# --- ENF Teorisi Özetini PDF'e ekle ---
teori_metni = [
    "ENF (Electric Network Frequency) Temelleri:",
    "",
    "1. ENF, elektrik şebekesinin anlık frekansıdır ve 50/60 Hz civarındadır.",
